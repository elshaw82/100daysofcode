...
**Today's Progress**: Went over Flow control - if statements, function returns, truthy, falsy again. Felt myself losing focus, so I created another soft UI design.
...
\*_Link(s) to work_ [Soft UI Calculator](https://codepen.io/elshaw82/full/GRoRBXK)
...
\*_Link(s) to work_ [Lightswitch - updated](https://codepen.io/elshaw82/full/QWjeEvM)
...
\*_Link(s) to work_ [Connect 4](https://github.com/elshaw82/Connect-4) [Soft UI Spotify](https://codepen.io/elshaw82/full/ZEQQQjy)
...
\*_Link(s) to work_ [Lava Lamp](https://codepen.io/elshaw82/full/MWKbvpZ)
...
\*_Link(s) to work_ [Lava Lamp](https://codepen.io/elshaw82/full/jOWyrem)
...
\*_Link(s) to work_ [Clueles Memory Game](https://codepen.io/elshaw82/full/bGEqpXy)
...
\*_Link(s) to work_ Nope! Just practice!
...
\*_Link(s) to work_ (NASA API)[https://codepen.io/elshaw82/full/qBbrgQR]
...
\*_Link(s) to work_ (Portfolio / responsive nav)[https://github.com/elshaw82/responsive-nav]
...
\*_Link(s) to work_ (Button Fun)[https://codepen.io/elshaw82/full/wvMqWLO]
...
\*_Link(s) to work_ (Animated Toaster)[https://codepen.io/elshaw82/full/XWXaBpr]
...
\*_Link(s) to work_ (Primavera Sound 2021 Countdown)[https://codepen.io/elshaw82/full/YzwrqBX]
...
\*_Link(s) to work_ (Toggle Slider)[https://codepen.io/elshaw82/full/XWXexWe]
...
\*_Link(s) to work_ (Random Cocktail Generator)[https://codepen.io/elshaw82/full/ZEQaWLy]
...
\*_Link(s) to work_ I did a lot of image gallery work, but it was a bit of pain to upload so many images so no link today.
...
\*_Link(s) to work_ Code was a mess and not responsive, so no links.

## Day 75: July 08 2020

**Today's Progress**: So today I didn't start coding until much later in the day. After feeling so frustrated and dishearted over the previous two days I didn't really know what I could work on and finish with what little time I had left. So, I opened up my failed project from monday and I did it! In less than an hour!! What a buzz to have your project brought to life and work! I'm so happy I gave it another shot.
